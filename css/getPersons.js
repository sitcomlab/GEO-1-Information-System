	$(document).on("pagebeforecreate",function(event){
		...
		var random = Math.random();
				...
				var mynavbar =	'<div data-role="navbar">'
								...
								+		'<li><a id ="photoTab" class="ui-btn-active" href="#photo" data-toggle="tab" onclick="photoClick()">Photo</a></li>'							
								+		'<li><a id="mapTab" href="#map" data-toggle="tab" onclick="mapClick()">Map</a></li>'
								+	'</ul>'
								+'</div>';	
				...
				var mynavbar =	'<div data-role="navbar">'
								+	'<ul id = "mapPhotoTab" style="display:none;">'
								+		'<li><a id="mapTab" class="ui-btn-active" href="#map" data-toggle="tab" onclick="mapClick()">Map</a></li>'
								+		'<li><a id ="photoTab" href="#photo" data-toggle="tab" onclick="photoClick()">Photo</a></li>'							
								+	'</ul>'
								+'</div>';	
				$(".maintenance_tabs").append(mynavbar).trigger('create');}
	});
	...
	$.post(
		...
		{	
			...
			function(data){
				...
				for ( var i = 0; i < data.length; i += 3 ){
					if ( data[i+1] == "StudLab" || data[i+1] == "Common section FrontOffice" || data[i+1] == "First aid room" || data[i+1] == "Zentrum Digitaler Medien (ZDM)" ||
						data[i+1] == "Zentrum Digitaler Medien (ZDM)"){
				...
				console.log(special);
				localStorage["special"] = special.substr(0,special.length-1);
				...
				var test = document.createTextNode("Rooms 001 - 099");
					document.getElementById("floor0").appendChild(test);			
				var test = document.createTextNode("Rooms 1 - 99");
					document.getElementById("floor1").appendChild(test);
				var test = document.createTextNode("Rooms 100 - 199");
					document.getElementById("floor2").appendChild(test);	
				var test = document.createTextNode("Rooms 200 - 299");
					document.getElementById("floor3").appendChild(test);
				var test = document.createTextNode("Rooms 300 - 399");
					document.getElementById("floor4").appendChild(test);
				var test = document.createTextNode("Rooms 400 - 499");
					document.getElementById("floor5").appendChild(test);
				var test = document.createTextNode("Rooms 500 - 599");
					document.getElementById("floor6").appendChild(test);							
				var test = document.createTextNode("Special");
		...
		$.post(
			...
			*/
			...
			$("#A").click(function(){
				log('Search for people with A',new Date())
			...
			$("#F").click(function(){
					log('Search for people with F',new Date())
					document.getElementById("people").innerHTML="";
			...
			$("#K").click(function(){
					log('Search for people with K',new Date())
					document.getElementById("people").innerHTML="";
			...
			$("#P").click(function(){
					log('Search for people with P',new Date())
					document.getElementById("people").innerHTML="";
			...
			$("#special").click(function(){
					log('Search for Special',new Date())
					document.getElementById("room").innerHTML="";
					...
					allRooms = allRooms.split(";");
						...
						for ( var i = 0; i < allRooms.length; i+=3 ) {  
									var content = "<div style = 'display:block;' data-role='collapsible' id='set" + i + "' class='A_E'><h3>" + allRooms[i+1] + 
												  "</h3><div><p style='margin-bottom:5px;'> Room:" + allRooms[i] + "</p>"+"<p style='margin-bottom:5px;'>" + allRooms[i+2] + "</p>"+
												  "<button id="+allRooms[i]+" class='ui-btn ui-btn-inline' style='margin-right: 30px; margin-bottom: 10px;' "+
												  "onclick=showNavigation(this.id)>Show Navigation</button></div></div>";							
								$( "#room" ).append( content ).collapsibleset( "refresh" );									
						}
			...
			$("#misc").click(function(){
					...
					var misc_length = allPeoplestaff.employees.length;
					
					for (var  i = 0; i < misc_length; i++ ) {  
